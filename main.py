...
from models import MLP_simple
from models import GMN_ORTHO, APPmem, APPmem2
...
if __name__ == '__main__':
    ...
    # Save results
    save_args = '_'.join(str(i) for i in [args.seed, args.sub_dataname, args.hidden, args.dropout, args.lr, args.weight_decay,
